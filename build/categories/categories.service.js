...
var CategoriesService = /** @class */ (function () {
    function CategoriesService(categoryModel) {
    ...
    CategoriesService.prototype.create = function (createCategoryDto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new this.categoryModel(createCategoryDto)];
                    case 1:
                        newCategory = _a.sent();
    ...
    CategoriesService.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.categoryModel.find().exec()];
    ...
    CategoriesService.prototype.update = function (id, updateCategoryDto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.categoryModel.findByIdAndUpdate(id, { $set: updateCategoryDto }, { new: true })];
                    case 1:
                        category = _a.sent();
                        return [2 /*return*/, category];
                }
    ...
    CategoriesService.prototype.remove = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.categoryModel.findByIdAndDelete(id)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    CategoriesService.prototype.isCategory = function (id, category) {
        if (!category) {
    ...
    CategoriesService = __decorate([
        common_1.Injectable(),
        __param(0, mongoose_2.InjectModel(category_entity_1.Category.name)),
