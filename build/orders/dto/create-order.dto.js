...
var CreateOrderDto = /** @class */ (function () {
    ...
    CreateOrderDto._OPENAPI_METADATA_FACTORY = function () {
        return { date: { required: true, type: function () { return Date; } }, customer: { required: true, type: function () { return String; } }, products: { required: true, type: function () { return [String]; } } };
    };
    __decorate([
