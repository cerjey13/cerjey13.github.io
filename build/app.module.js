    ...
    AppModule = __decorate([
        common_1.Module({
            ...
            providers: [
                ...
                {
                    provide: 'TASKS',
                    useFactory: function (http) { return __awaiter(void 0, void 0, void 0, function () {
                        var tasks;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, http.get('https://jsonplaceholder.typicode.com/todos')];
                                case 1:
                                    tasks = _a.sent();
                                    return [4 /*yield*/, rxjs_1.firstValueFrom(tasks)];
